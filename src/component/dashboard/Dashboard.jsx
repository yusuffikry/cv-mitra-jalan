...
//**NOTE: PEMASUKAN, PENGELUARAN jika salah satu nilainya tinggi maka cardnya jadi warna hijau mas
      ...
      <main className="flex-1 flex flex-col overflow-y-auto">
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard title="Pemasukan (Rp)" value="1,240" color="green" />
            <StatCard title="Pengeluaran (Rp)" value="2,250" color="red" />
            <StatCard title="Mobil Standby" value="8 Pending" color="yellow" />
            <StatCard title="Mobil Jalan" value="3 Item" color="blue" />
          </div>
          {/* line chart */}
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 w-full">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-700">Profit</h3>
                  <p className="text-xs text-gray-400">
                    Pemasukan dan Pengeluaran
                  </p>
                </div>
              </div>
              <select className="text-xs border rounded-md px-2 py-1 outline-none focus:ring-2 focus:ring-blue-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-5 border-b bg-gray-50/50  ">
                <h3 className="font-bold text-gray-700">Daftar Kendaraan</h3>
              </div>
