          ...
          >
            <thead className="bg-white">
              <tr style={{ backgroundColor: "#f8f9fa" }}>
                {/* PEMBAGIAN PERSENTASE LEBAR KOLOM TERBARU (TOTAL 100%) */}
                <th className="p-2 text-secondary fw-bold text-uppercase border-bottom text-center" style={{ width: "4%" }}>No</th>
                ...
                {/* Lebar Transmisi ditambah jadi 9% agar "TRANSMISI" muat 1 baris utuh */}
                    ...
                    <tr key={car.cars_id}>
                      ...
                      <td className="p-2">
                        ...
                        <div className="text-muted" style={{ fontSize: "0.65rem" }}>
                          {car.tipe_kendaraan || "-"} <br/> {car.tahun_produksi || "-"}
                        </div>
                      </td>
                      ...
                      <td className="p-2 align-middle">
                        <div className="fw-bold text-dark" style={{ fontSize: "0.7rem" }}>
                          <i className="fas fa-map-marker-alt text-primary me-1"></i> {gps1Nomor || "Belum didaftarkan"}
                        </div>
                        {gps1Aktif && (
                          <div className="mt-1">
                      ...
                      <td className="text-muted p-2" style={{ fontSize: "0.7rem" }}>
                        {car.keluhan_unit || "-"}
                      </td>
            ...
            <div className="modal-content border-0 shadow-lg" style={{ borderRadius: "16px" }}>
              <div className="modal-body p-4 text-center">
                ...
                <p className="text-muted mb-4" style={{ fontSize: "0.9rem" }}>
                  ...
                  <span className="badge bg-light border text-dark mt-2 px-3 py-2" style={{ letterSpacing: "1px" }}>Plat: {carToDelete?.plate}</span>
                </p>
                ...
                <div className="d-flex gap-2">
                  <button type="button" className="btn btn-light w-50 fw-bold border shadow-sm" style={{ borderRadius: "10px" }} onClick={cancelDelete}>Batal</button>
                  <button type="button" className="btn btn-danger w-50 fw-bold shadow-sm" style={{ borderRadius: "10px" }} onClick={confirmDelete}>Ya, Hapus</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="modal-dialog modal-dialog-centered modal-sm">
            <div className="modal-content border-0 shadow-lg" style={{ borderRadius: "16px" }}>
              <div className="modal-body p-4 text-center">
                ...
                <p className="text-muted mb-3" style={{ fontSize: "0.9rem" }}>Kendaraan <span className="fw-bold text-dark">{carToDelete?.name}</span> telah berhasil dihapus dari sistem.</p>
